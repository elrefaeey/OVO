    ...
    <nav className="bg-white/95 backdrop-blur-sm sticky top-0 z-50 border-b border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="text-2xl font-bold text-stone-800 tracking-wider">
            OVO
          </Link>
          ...
          <div className="flex items-center space-x-8">
            ...
            <Link 
              to="/products" 
              className={`text-stone-600 hover:text-stone-800 transition-colors ${
                isActive('/products') ? 'text-stone-800 font-medium' : ''
              }`}
            >
              Products
            </Link>
            <Link 
              to="/cart" 
              className={`relative text-stone-600 hover:text-stone-800 transition-colors ${
                isActive('/cart') ? 'text-stone-800 font-medium' : ''
              }`}
            >
